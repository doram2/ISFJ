...
public class Ex15 {
	...
	public static void main(String[] args) {
		...
		int result = day1.compareTo(day2); //day1을 day2와 비교
		System.out.println(result);//목요일은 화요일에서 2일 지남
		result = day2.compareTo(day1); //day2를 day1와 비교
		System.out.println(result);//화요일은 목요일에서 2일 전
